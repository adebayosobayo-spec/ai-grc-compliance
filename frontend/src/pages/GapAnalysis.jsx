  ...
  return (
    <div className="mt-6 bg-[#111827] rounded-xl border border-white/[0.06] p-6 text-center">
      <div className="mb-4">
        ...
        <p className="text-slate-100 font-bold text-sm">Running Gap Analysis</p>
        <p className="text-slate-400 text-xs mt-1 font-mono">{LOADING_MESSAGES[msgIndex]}</p>
      </div>
      <div className="w-full bg-white/[0.07] rounded-full h-1 mb-3">
        <div className="h-1 rounded-full transition-all duration-1000 bg-gradient-to-r from-primary-600 to-primary-400"
